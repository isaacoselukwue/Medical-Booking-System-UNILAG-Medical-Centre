...
<div class="container">
    <div class="margin-top">
        <div class="row">
            ...
            <p>I was delighted with the treatment. Despite me being a somewhat difficult patient the nurses and doctors were really gentle, patient and understanding.
            ...
            <div class="span6">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="table  table-bordered" id="example">
                    ...
                    <tbody>
                        ...
                        <?php
                        $user_query = mysql_query("select * from schedule where member_id = '$session_id' ")or die(mysql_error());
            ...
            <div class="span3">
                ...
                <div class="alert alert-info">Dr. Mrs Ramota Apampa</div>	
